...
class App(object):
    ...
    def checkedge(self,event):
        ...
        for i in range(len(self.nodes_pos)):
            ...
            if(abs((pos[0]-check[0])**2-(pos[1]-check[1])**2)<225):
                self.startx=pos[0]
                self.starty=pos[1]
                if(self.directed==1):
    ...
    def onrelease(self,event):
        ...
        if(self.Eflag==1 and self.drawcheck==1):
            ...
            for i in range(len(self.nodes_pos)):
                ...
                if(int(abs((pos[0]-check[0])**2-(pos[1]-check[1])**2))<225 and self.checker1==1):
                    self.flag=1
                    break
            ...
            if(self.flag==1 and self.checker1==1):
                for x in range(len(self.nodes_pos)):
                    ...
                    if(abs((self.startx-check[0])**2-(self.starty-check[1])**2)<225):
                        p=1
                        break
        ...
        if(self.snodenum is not -1):
            ...
            for k in range(len(arr)):
                ...
                try:
                    ...
                    if(x1<=x2 and y1>=y2):
                        ...
                        pos1=(x1-15*math.cos(theta),y1+15*math.sin(theta))
                        pos2=(x2+15*math.cos(theta),y2-15*math.sin(theta))
                    if(self.curved_edges[self.snodenum+1][arr1[k]]>0):
                        print("y")
                        xc=(pos1[0]+pos2[0])/2
                        yc=(pos1[1]+pos2[1])/2
                        #p4=xc+yd  q4=yc-xd;
            ...
            for k in range(len(darr)):
                ...
                try:
                    ...
                    if(self.curved_edges[darr[k]][self.snodenum+1]>0):
                        print("dy")
                        xc=(pos1[0]+pos2[0])/2
                        yc=(pos1[1]+pos2[1])/2
                        #p4=xc+yd  q4=yc-xd;
                    ...
                    x1=(prevpos[0]+pos[0])/2
                    y1=(prevpos[1]+pos[1])/2
                    enmov.place(x=(prevpos[0]+x1)/2,y=(prevpos[1]+y1)/2)'''
                except:
                    pass
